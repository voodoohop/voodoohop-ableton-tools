...
// const camelotToColors = invert(camelotToKey).map((camelot,key) => keysToColor)
...
const keysToCam = {
		...
		"g":"9b", "em":"9a",
		"d":"10b", "bm":"10a",
		"a":"11b", "gbm":"11a","f#m":"11a",
		"e":"12b", "dbm":"12a","c#m":"12a",
		"b":"1b", "abm":"1b","g#m":"1a",
		"gb":"2b", "f#":"2b", "d#m":"2a", "ebm":"2a",
...
export const keysToCamelot = (key) => key ? keysToCam[key.toLowerCase()] :"undefined";

export const keysToOpenkey = (key) => camToOpenKey[keysToCamelot(key)];

// const logInOut = (notation,keyFormatter) => (key) => {
//     const result = keyFormatter(key);
//     console.log("formatting key", key, "result:", result,"notation:",notation,keyFormatter);
//     // console.trace();
//     return result;
// }
